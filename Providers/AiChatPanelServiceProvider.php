...
class AiChatPanelServiceProvider extends ServiceProvider
{
    ...
    protected function registerAssets()
    {
        ...
        \Eventy::addFilter('javascripts', function ($javascripts) {
            ...
            //
            // There is deliberately no generated vars.js beside it: the
            // strings module.js needs travel as a data- attribute instead,
            // because no install path in core ever runs the command that would
            // build one. See Services/JsStrings.php.
            $files = [
                '/js/module.js',
            ];
